...
- 🏠 **Backend Java - Site Quase Tudo Gostoso**  
  https://github.com/diegosilveira94/quasetudogostoso-java  
  Backend em Java de um site de receitas criado como projeto interdisciplinar.

- 🎮 **Sistema Bancário**  
  https://github.com/diegosilveira94/sistema-bancario  
  Sistema bancário aplicado POO com validações (Bootcamp Santander 2025)
